...
// Tuple of allowed verification levels. Single source of truth — the
// `searchBusinessesSchema` zod enum below must mirror this list. Update
// here, then propagate to schemas that consume it.
