...
/**
 * EmptyState — zero-data surface used whenever a user has no reviews,
 * no businesses, etc. Soft icon bubble, copy, optional CTAs. Lives
 * under `components/ui/` so both the (now-removed) dashboard and
 * other surfaces can share it.
 */
