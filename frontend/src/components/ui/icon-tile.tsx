...
/**
 * IconTile — small soft-gradient icon bubble used in stat cards,
 * quick actions, and empty states. Floats and scales on hover so
 * cards feel alive without being noisy.
 */
