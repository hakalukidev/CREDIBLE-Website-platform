...
import { contactSubmissionsRouter } from '../modules/contact/submissions.controller';
import { dataRequestsRouter } from '../modules/users/data-requests.controller';
...
router.get('/health', async (_req, res) => {
  ...
  router.use('/contact', contactSubmissionsRouter);
  router.use('/users/me/data-requests', dataRequestsRouter);
